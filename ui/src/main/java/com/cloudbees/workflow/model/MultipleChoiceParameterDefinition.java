package com.cloudbees.workflow.model;
 ...
 * @author huybrechts
 */
public class MultipleChoiceParameterDefinition extends SimpleParameterDefinition {
    ...
    public MultipleChoiceParameterDefinition(String name, String choices, String description) {
    ...
    private MultipleChoiceParameterDefinition(String name, List<String> choices, String defaultValue, String description) {
        super(name, description);
    ...
    public MultipleChoiceParameterDefinition(String name, String description) {
        super(name, description);
    ...
    public ParameterDefinition copyWithDefaultValue(ParameterValue defaultValue) {
        if (defaultValue instanceof StringParameterValue) {
            ...
            return new MultipleChoiceParameterDefinition(getName(), choices, value.value, getDescription());
        } else {
            return this;
        }
    }
    ...
    @Extension @Symbol({"multipleChoice","multipleChoiceParam"})
    public static class DescriptorImpl extends ParameterDescriptor {
        @Override
        public String getDisplayName() {
            return Messages.MultipleChoiceParameterDefinition_DisplayName();
        }
        ...
        public ParameterDefinition newInstance(@Nullable StaplerRequest req, @Nonnull JSONObject formData) throws FormException {
            ...
            return new MultipleChoiceParameterDefinition(name, choiceText, desc);
        }
        ...
        public FormValidation doCheckChoices(@QueryParameter String value) {
            if (MultipleChoiceParameterDefinition.areValidChoices(value)) {
                return FormValidation.ok();
            } else {
                return FormValidation.error(Messages.MultipleChoiceParameterDefinition_MissingChoices());
            }
        }
    }
